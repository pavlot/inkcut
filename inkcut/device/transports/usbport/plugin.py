...
class UsbPortTransport(DeviceTransport):

    #: Default config
    config = Instance(UsbPortConfig, ()).tag(config=True)
...
class UsbPortPlugin(Plugin):
    """ Plugin for handling usb port communication
